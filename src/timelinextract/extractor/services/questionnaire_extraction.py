...
from extractor.utils.data_processing import extract_json, save_merged_data_to_json
from extractor.utils.prompts import PROMPTS
...
def send_to_chatgpt(pdf_file_path):
    ...
    try:
        ...
        return {"error": f"Failed to process PDF with GPT-4o: {e}"}

    finally:
        # Ensure cleanup of the uploaded file if necessary
